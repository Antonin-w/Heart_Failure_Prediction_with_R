...
When we have a look at the result, we can see that there is a plateau with the highest accuracy rate around k = 40, and seem to be the best k value for our dataset. 
