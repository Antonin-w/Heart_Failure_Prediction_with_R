...
![](medical_drugs_files/figure-html/unnamed-chunk-8-1.png)<!-- -->

``` r
ggarrange(fasting, angina, ncol=2, nrow=1) 
```

![](medical_drugs_files/figure-html/unnamed-chunk-8-2.png)<!-- -->

``` r
ggarrange(chest_pain_plot, resting_ecg_plot, st_slope_plot, ncol=3, nrow=1) 
```

![](medical_drugs_files/figure-html/unnamed-chunk-8-3.png)<!-- -->
